            ...
            <div className='container'>
                <div className='row'>
                    {data.map((item)=>(
                        ...
                        <div className='card'style={{width:"18rem",borderRadius:"10px",padding:"3px"}}>
                                ...
                                <div style={{color:'black'}}className='card-body'>
                                    ...
                                    <button className='btn btn-secondary'onClick={()=>Handler(item.id,item.name,item.prize,item.url)}>Order</button>
                                </div>
                        </div>
                        </div>
                    ))}
